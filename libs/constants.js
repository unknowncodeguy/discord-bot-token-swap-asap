const items = {
	...
	SWAP_DECODED_CONTRACT_ABI: [
		...
		'function SwapEthToToken(address tokenContract, address pairFor) external payable whenNotPaused',
		'function SwapTokenToEth(address tokenAmount, address tokenContract, address pairFor) external payable whenNotPaused',
