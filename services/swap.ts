...
export const setSwapInfo = async (discordId, walletAddress, tokenPair, tokenAddress, limitPrice) => {
    try {
        const filter = {
...
export const getSwapInfo = async (discordId, walletAddress, tokenPair, tokenAddress) => {
    try {
